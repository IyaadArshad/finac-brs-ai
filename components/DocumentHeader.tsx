  ...
  return (
    <div className="relative flex items-center justify-center">
      <button
        ...
        disabled={disabled}
        onClick={onClick}
        className={`group relative h-10 rounded-lg px-2 text-[#1A479D] hover:bg-[#1A479D]/10 focus-visible:outline-0 ${
...
export function DocumentHeader({
  ...
  const canGoToPreviousVersion =
    versionData?.currentVersion !== undefined &&
    versionData?.currentVersion > 1;
  const canGoToNextVersion =
    versionData?.currentVersion !== undefined &&
    versionData?.currentVersion < (versionData?.latestVersion || 0);
  ...
  return (
    <>
      <header className="sticky top-0 flex bg-white h-14 items-center justify-between gap-1 px-3">
        <div className="flex flex-1 basis-0 items-center gap-1 truncate leading-[0]">
          <DropdownMenu>
            <DropdownMenuTrigger className="grid grid-cols-[1fr_auto] items-center rounded-lg p-1 hover:cursor-pointer hover:bg-gray-100 text-left">
              <h1 className="max-w-[290px] overflow-hidden truncate text-xl font-sans pr-2 pl-3">
                {documentName}
                {versionData &&
        ...
        <div className="flex min-w-0 basis-auto items-center gap-1.5">
